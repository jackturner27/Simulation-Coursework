...
public class SimpleThreeStateCA {
    ...
    public static void main(String args[]) throws Exception {
        ...
        /*// Define initial state - excited centre / resting elsewhere.
        for (int i = 0; i < N; i++) {
            for (int j = 0; j < N; j++) {
                state[i][j] = j == N / 2 ? i == N / 2 ? 2 : 0 : 0;
            }
        }*/
        
    	// Define initial state - excited top left / resting elsewhere.
        for (int i = 0; i < N; i++) {
            for (int j = 0; j < N; j++) {
                state[i][j] = j == 0 ? i == N - 1 ? 2 : 0 : 0;
            }
        }
